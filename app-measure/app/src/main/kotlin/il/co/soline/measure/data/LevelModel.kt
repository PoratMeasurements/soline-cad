...
data class LevelPointEntity(
    ...
    /**
     * הקריאה נקלטה **ללא זווית-אנכית** (vAngleDeg=null) — ה-Z נפל-חזרה למרחק-הגלם
     * ולכן הסטייה בקנה-מידה שגוי ואינה-אמינה. דגל-קבוע (שורד-סיבוב/מות-תהליך, בניגוד
     * לאזהרה-הזמנית הקודמת) שמניע את סימון-השורה. נקודת-ה-0 לעולם לא נשמרת ללא-זווית.
     */
    val noAngle: Boolean = false,
)
