 ...
 *
 * זו המקבילה שלנו לפונקציית "Close" של InnoDraw (INNODRAW_FEATURES §2/§5:
 * Close Auto/Manual, Attach / Attach External Walls, Intersection) ולחיבור-ה-T של
 * Cabinet Vision (CVSM_FEATURES §5.5 — "הקיר השני נחתך/מוארך עד הראשון; הראשון לא זז").
...
object WallCloseTools {
    ...
    /**
     * **Close-Auto** — סוגר את היקף-החדר אוטומטית (INNODRAW §2/§5).
     *
     ...
     * הלא-סמוך (CVSM §5.5, INNODRAW "Attach"). "הקיר-השני נחתך/מוארך עד הראשון; הראשון לא זז."
     *
    ...
    /**
     * **סגירה ידנית** (INNODRAW "Close: Manual") — מחזיר קיר **חדש** המחבר את
