...
/* ─────────────────────────────────────────────────────────────────────────────
 *  RoomTemplateWizard — אשף-תבניות-החדר (תבניות-צורה + ריבוע-מהיר).
 *
 *  בוחרים צורה (מלבן/L/U/T/Z), ממלאים מידות, ורואים תצוגה-מקדימה חיה של המתאר.
 *  "צור קירות" מייצר את כל הקירות בבת-אחת (כל הפינות 90°, המתאר סגור).
 *  שיקוף (mirror) וקיר-התחלה (סובב) נתמכים.
 * ───────────────────────────────────────────────────────────────────────────── */
