...
/**
 * אשף-תבניות-החדר (Room-template wizard) — תבניות מלבן/L/U/T/Z וריבוע-מהיר.
 *
 * התבנית נבנית מקלט-מספרי: לכל צורה פרמטרים-מספריים שמהם נגזרת הצורה — **כל
 * הפינות 90°, והמתאר נסגר תמיד** (ערבות-גאומטרית).
 *
...
object RoomTemplates {
     ...
     * קיר-ההתחלה ע"י הזזת-נקודת-הפתיחה — פעולת "סובב").
     *
