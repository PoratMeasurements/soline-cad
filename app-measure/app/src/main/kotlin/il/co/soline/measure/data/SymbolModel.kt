...
/* ─────────────────────────────────────────────────────────────────────────────
 *  סמלי-CAD מותאמים-אישית ("סמל חדש") — Soline Measure.
 *
 *  כפתור "סמל חדש" בבורר יוצר סמל מבוסס צורת-בסיס (מלבן / מלבן מעוגל / עיגול /
 *  משולש / מעוין) עם תווית קצרה משלכם. הסמלים המותאמים נשמרים ומוצעים שוב בכל פרויקט.
 *
