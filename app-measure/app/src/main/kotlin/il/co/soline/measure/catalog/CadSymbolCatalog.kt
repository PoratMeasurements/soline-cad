...
/*
 * קטלוג סמלי-CAD של Soline Measure — מיושר ל-CVSM #f-cad-symbol / #f-elev-cadsymbol.
 *
 * (מדריך CVSM, cvsm_reference/CVSM_guide_he.html §"סמלי CAD"):
 *   "25 סמלים מוכנים: טלוויזיה, רמקול, מקרן, תרמוסטט, אינטרקום, גלאי עשן, נקודת רשת,
 *    מאוורר תקרה · שולחן, כיסא, ספה, מיטה, שולחן עבודה, ארון בגדים · מכונת כביסה,
 *    מייבש כביסה, מקלחת, רדיאטור, דוד מים, כיור · עמוד, מדרגות, נישה, פיר אוורור, סימון פתח."
 *
...
/** חמש קטגוריות הבורר הדו-שלבי (מדריך §f-cad-symbol). "הסמלים שלי" = מותאמים-אישית. */
