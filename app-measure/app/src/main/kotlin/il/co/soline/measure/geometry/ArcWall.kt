...
/**
 * קיר-קשת (Arc wall) — פורט מ-CVSM ("RoomMeasure"), כרטיס `#f-plan-3dcapture`
 * ("קשת (3 נק')") ו-`#f-meas-p2p`. ב-CVSM הקשת מוגדרת ע"י **3 נקודות** (התחלה,
 * אמצע, סוף) והמעגל נגזר מהן; אין פרמטר-רדיוס/בליטה מפורש.
 *
 ...
 *
 *  1. [circleFrom3Points] / [arcThrough3Points] — הדרך ה"נאמנה" של CVSM (3 נק'
 ...
 *
 * הערה (מ-CVSM `#f-wall-tjoin`): קיר-קשת **מסרב לחיבור-T** — הגאומטריה של קשת לא
...
object ArcWall {
    ...
    // ------------------------------------------------------------------
    // דרך CVSM הנאמנה — מעגל/קשת דרך 3 נקודות
    // ------------------------------------------------------------------
